...
public class HomeWork {
    public static void main(String[] arg) {
        ...
        Object[] a = new Object[]{1, 2, "a", "b", "aasf", "1", "231", 231};       //input
    ...
    static Character first_non_repeating_letter(String str) {                   //TASK №2
        String new_srt = str.toLowerCase();
        int index = 0;
        for (Character ch : new_srt.toCharArray()) {
            if (new_srt.indexOf(ch) == new_srt.lastIndexOf(ch)) {
                index = new_srt.indexOf(ch);
                break;
            }
        }
